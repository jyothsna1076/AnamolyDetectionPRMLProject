...
def train_logistic_regression():
    ...
    # Save encoders
    os.makedirs("models/LR_models", exist_ok=True)
    joblib.dump(le_protocol, "models/LR_models/le_protocol.pkl")
    joblib.dump(le_service, "models/LR_models/le_service.pkl")
    joblib.dump(le_flag, "models/LR_models/le_flag.pkl")
    ...
    joblib.dump(scaler, "models/LR_models/scaler.pkl")
    ...
    joblib.dump(model, "models/LR_models/classifier.pkl")
