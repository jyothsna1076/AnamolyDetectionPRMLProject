...
def train_svm():
    ...
    for col in cat_cols:
        ...
        encoders[col] = le
    joblib.dump(encoders, 'models/SVM_models/label_encoders.pkl')
    ...
    joblib.dump(target_encoder, 'models/SVM_models/target_encoder.pkl')
    ...
    os.makedirs("models/SVM_models", exist_ok=True)
    joblib.dump(X.columns.tolist(), 'models/SVM_models/feature_order.pkl')

    # === Scale Features ===
    scaler = StandardScaler()
    X_scaled = scaler.fit_transform(X)
    joblib.dump(scaler, 'models/SVM_models/scaler.pkl')
    ...
    joblib.dump(svm, 'models/SVM_models/SVM_best_model.pkl')
